...
class SelectTravelPlanScreen extends StatefulWidget {
  ...
  @override
  State<SelectTravelPlanScreen> createState() => _SelectTravelPlanScreenState();
}
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              constraints: BoxConstraints(maxHeight: 0.65.sh, maxWidth: 0.9.sw),
              child: Column(
                children: [
                  Expanded(
                    child: TabBarView(

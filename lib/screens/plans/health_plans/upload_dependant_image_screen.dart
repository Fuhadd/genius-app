...
class UploadDependantImageScreen extends StatefulWidget {
  const UploadDependantImageScreen({
    super.key,
  });

  @override
  State<UploadDependantImageScreen> createState() =>
      _UploadDependantImageScreenState();
}

class _UploadDependantImageScreenState extends State<UploadDependantImageScreen>
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            verticalSpacer(8.h),
            mediumText(
              'Upload or take a clear image of the dependant',
              fontSize: 14.sp,
              color: CustomColors.primaryGreenColor,
            ),
            verticalSpacer(43.h),
